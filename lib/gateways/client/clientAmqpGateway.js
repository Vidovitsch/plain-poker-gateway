...
C.onCreateTableRequest = function onCreateTableRequest(callback) {
  this.eventMessager.onEvent('table_default', 'table_default', 'create-table-request', (err, requestMessage) => {
 ...
 * @param  {Function} callback [description]
 */
C.onJoinTableRequest = function onJoinTableRequest(callback) {
  this.eventMessager.onEvent('table_default', 'table_default', 'join-table-request', (err, requestMessage) => {
    callback(err, requestMessage);
  });
};
