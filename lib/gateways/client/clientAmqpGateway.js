...
C.onCreateTableRequest = function onCreateTableRequest(callback) {
  this.eventMessager.onEvent('table_default', 'create-table-request', (err, requestMessage) => {
...
C.onJoinTableRequest = function onJoinTableRequest(callback) {
  this.eventMessager.onEvent('table_default', 'join-table-request', (err, requestMessage) => {
    callback(err, requestMessage);
  });
};
