...
/**
 * [onCheckGameRequestAsync description]
 * @param  {String}   channelKey  [description]
 * @param  {String}   receiveFrom [description]
 * @param  {Function} callback    [description]
 */
C.onCheckGameRequestAsync = function onCheckGameRequestAsync(channelKey, receiveFrom, callback) {
  const args = {
    queue: receiveFrom,
...
/**
 * [onCallGameRequestAsync description]
 * @param  {String}   channelKey  [description]
 * @param  {String}   receiveFrom [description]
 * @param  {Function} callback    [description]
 */
C.onCallGameRequestAsync = function onCallGameRequestAsync(channelKey, receiveFrom, callback) {
  const args = {
    queue: receiveFrom,
...
/**
 * [onBetGameRequestAsync description]
 * @param  {String}   channelKey  [description]
 * @param  {String}   receiveFrom [description]
 * @param  {Function} callback    [description]
 */
C.onBetGameRequestAsync = function onBetGameRequestAsync(channelKey, receiveFrom, callback) {
  const args = {
    queue: receiveFrom,
    context: 'bet-request',
    channelKey,
...
/**
 * [onRaiseGameRequestAsync description]
 * @param  {String}   channelKey  [description]
 * @param  {String}   receiveFrom [description]
 * @param  {Function} callback    [description]
 */
C.onRaiseGameRequestAsync = function onRaiseGameRequestAsync(channelKey, receiveFrom, callback) {
  const args = {
    queue: receiveFrom,
...
/**
 * [onFoldGameRequestAsync description]
 * @param  {String}   channelKey  [description]
 * @param  {String}   receiveFrom [description]
 * @param  {Function} callback    [description]
 */
C.onFoldGameRequestAsync = function onFoldGameRequestAsync(channelKey, receiveFrom, callback) {
  const args = {
    queue: receiveFrom,
