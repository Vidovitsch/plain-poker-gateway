...
T.sendCreateDealerReply = function sendCreateDealerReply(replyData, requestMessage) {
...
T.onCreateDealerRequest = function onCreateDealerRequest(channelKey, callback) {
  this.eventMessager.onEvent('table_default', 'create-dealer-request', channelKey, (err, message) => {
    callback(err, message);
  });
};
