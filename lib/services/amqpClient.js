 ...
 */
AmqpClient.prototype.sendAsync = function(message, queue) {
 ...
 * @return {Promise}            [description]
 */
AmqpClient.prototype.fanoutAsync = function(message, routingKey) {
    return new Promise((resolve, reject) => {
        // Create promises
        const connectionPromise = this.connectAsync();
        const channelPromise = connectionPromise.then((connection) => {
 ...
 */
AmqpClient.prototype.listen = function(channel, queue, callback) {
...
AmqpClient.prototype.bindQueue = function(channel, queue, routingKey) {
